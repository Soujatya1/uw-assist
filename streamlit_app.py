...
Also, assign scores based on the Medical and Financial Underwriting (how good the reports/info are), also an overall score for better clarity of the insurer's status as per follows(in a tabular format):
Medical Underwriting: High Risk (0-30), Medium Risk (31-60), Low Risk (61-100)
Financial Underwriting: High Risk (0-30), Medium Risk (31-60), Low Risk (61-100)
Overall: High Risk (0-30), Medium Risk (31-60), Low Risk (61-100)
Question: {question} 
Context: {context} 
Answer:
"""
